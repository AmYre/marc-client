				...
				<div className="flex flex-col md:flex-row gap-12">
						...
						<Link href="/museum/showcased" className="relative w-full cursor-pointer">
							<div className="product-frame relative w-full overflow-hidden">
								<div className="overlay relative">
									<Image className="w-full hover:scale-105 object-cover transition-all duration-1000 overflow-hidden" src="/bg1.jpg" alt="Image produit" width="500" height="500" />
								</div>
					...
					<motion.div
						...
						<Link href="/museum/sold" className="relative w-full cursor-pointer">
							<div className="product-frame relative w-full overflow-hidden">
								<div className="overlay relative">
									<Image className="w-full hover:scale-105 object-cover transition-all duration-1000 overflow-hidden" src="/bg2.jpg" alt="Image produit" width="500" height="500" />
								</div>
								<div className="absolute bottom-0 w-full bg-black bg-opacity-50 py-[10px] shadow">
